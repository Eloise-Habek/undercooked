    ...
    return (
      <div className={classes.wrapper}>
        <div className={classes.img_and_username}>
          <NavLink
            to={
              details !== undefined ? "/profile/" + details.author.username : ""
            }
          >
            <img src={require("../pages/images/chef.png")} alt="profile_icon" />
          </NavLink>

          <div className={classes.username_line}>
            {details !== undefined ? details.author.username : ""}
          </div>

          <div className={classes.timestamp_line}>
        ...
        secureLocalStorage.getItem("isAdmin") ? (
          <button
            className={classes.edit_comment_btn}
            type="button"
