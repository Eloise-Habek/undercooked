\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC1 - Pregled recepata na naslovnoj stranici}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Korisnik
						\item \textbf{Cilj: }Pregledati objavljene recepte prikazane na naslovnoj stranici aplikacije
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }-
						\item \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
								\item Pri učitavanju aplikacije prikazuje se naslovna stranica
								\end{packed_enum}
					\end{packed_item}
					
					\noindent \underbar{\textbf{UC2 - Pretraživanje recepata po kategorijama}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Upisuje ključnu riječ ili oznaku
					...
					\noindent \underbar{\textbf{UC5 - Objavljivanje recepta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC6 - Uređivanje objave}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - Brisanje objave}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8 - Prikazivanje tuđeg korisničkog profila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 - Slanje poruke drugom registriranom korisniku}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC10 - Zaprati korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11 - Pozovi korisnika na video poziv}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC12 - Pregled inboxa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 - Odgovaranje na poruku}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Poslati odgovor na dobivenu poruku
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC12 (Otvaranje inboxa)
						\item \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC14 - Ocijeni objavu ili označi sa "sviđa mi se"}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Ocijeniti recept ili ga označiti kako bi ga se kasnije moglo lakše opet pronaći
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC4 (Prijava)
						\item \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC15 - Spremi recept kao .pdf datoteku}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Lokalno spremiti recept za ispis ili pregledavanje neovisno o aplikaciji
						\item \textbf{Sudionici: } Baza podataka
						\item \textbf{Preduvjet: } UC4 (Prijava)
						\item \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Recept se čita iz baze podataka, pretvara u .pdf datoteku i šalje korisniku elektroničkom poštom
							%Možda je lakše napraviti http download nego slati mailom?
						\end{packed_enum}
					\end{packed_item}
										
					\noindent \underbar{\textbf{UCx16 - Komentiraj objavljeni recept}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 - Pregled vlastitog profila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Pregled najdražih recepata}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Prikazati korisnikove najdraže recepte
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC17 (Pregledavanje vlastitiog profila)
						\item \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Korisnik odabire opciju za pregled recepata koje je označio s 5 zvjezdica
							\item Odgovarajući recepti dohvaćaju se iz baze i prikazuju korisniku
						\end{packed_enum}
					\end{packed_item}
										
					\noindent \underbar{\textbf{UC19 - Pregled profila koje korisnik prati}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC20 - Pregled osobnih postavki}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Brisanje vlastitog profila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Uređivanje osobnih postavik}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Pregled povijesti aktivnosti}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Pregledavanje povijesti aktivnosti na profilu (objava recepata, komentiranje, praćenje drugih korisnika, slanje poruka...)
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC17 (Pregledavanje vlastitog profila)
						\item \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Korisnik odabire opciju za pregled povijesti aktivnosti
							\item Povijest se dohvaća iz baze podataka i prikazuje korisniku
						\end{packed_enum}
					\end{packed_item}
										
					\noindent \underbar{\textbf{UC24 - Uređivanje oznaka recepta}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Administrator
						\item \textbf{Cilj: }Dodavanje ili brisanje oznaka objavljenog recepta
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC4 (Prijava)
						\item \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Odabire opciju za uređivanje
							\item Dodaje nove ili briše postojeće oznake
