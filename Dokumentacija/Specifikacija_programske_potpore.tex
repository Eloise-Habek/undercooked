	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik na prikazanom receptu stiskanjem gumbova (+/-) ažurira broj porcija
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.5]{slike/aktivnost.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
