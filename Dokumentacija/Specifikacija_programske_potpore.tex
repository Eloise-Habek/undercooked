	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Dodavanje nove oznake koju ostali korisnici mogu koristiti za označavanje recepata i pretraživanje
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC
						\item \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Korisnik pri objavi ili uređivanju recepta upisuje oznaku koja se ne nalazi u bazi podataka
							\item Nova oznaka se zapisuje u bazu podataka i spremna je za korištenje
						\end{packed_enum}
					\end{packed_item}
