\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
					...
					\noindent \underbar{\textbf{UC7 - Prikaz najnovijih recepta praćenih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 - Uređivanje objave}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11 - Slanje poruke drugom registriranom korisniku}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC12 - Zaprati korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 - Pozovi korisnika na video poziv}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC14 - Pregled inboxa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC15 - Odgovaranje na poruku}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Poslati odgovor na dobivenu poruku
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC14 (Otvaranje inboxa)
						\item \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC16 - Ocijeni objavu}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 - Spremi recept}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Komentiraj objavljeni recept}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Pregled vlastitog profila}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC20 - Pregled spremljenih recepata}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Prikazati korisnikove najdraže recepte
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC19 (Pregledavanje vlastitog profila)
						\item \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC21 - Pregled profila koje korisnik prati}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Pregled osobnih postavki}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC23 - Brisanje vlastitog profila}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: }Registrirani korisnik
						\item \textbf{Cilj: }Brisanje vlastitog korisničkog profila
						\item \textbf{Sudionici: }Baza podataka
						\item \textbf{Preduvjet: }UC22 (Pregled osobnih postavki)
						\item \textbf{Opis osnovnog tijeka:}
					...
					\noindent \underbar{\textbf{UC24 - Uređivanje osobnih postavki}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC25 - Dodavanje novog administratora}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Brisanje recepta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC28 - Pregled mogućnosti administratora}}
					\begin{packed_item}
