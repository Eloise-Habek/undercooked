\chapter{Arhitektura i dizajn sustava}
	...
	% \end{itemize}
		...
		\section{Dijagram komponenti}
			...
			Slika \ref{fig:dijagram_komponenti} pruža prikaz organizacije komponenata, internih struktura, njihovih međusobnih odnosa te njihovih veza s okolinom. Spring Boot korišten pri izradi aplikacije, koristi se za brzu i lagano pokretljivu izgradnju servera koji obrađuje HTTP zahtjeve putem definiranih REST API endpointa. Preko sučelja za dohvat HTML, CSS i JS datoteka poslužuju se datoteke koje pripadaju frontend dijelu aplikacije. App.js, tj. Router omogućava navigaciju između različitih stranica, Home, Login, Register, Profile i AdminPage. To je komponenta koja na upit s url određuje koja datoteka će se poslužiti na sučelje. 
