	...
	\end{itemize}
		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
                ...
                \textbf{Komentar} Ovaj entitet sadržava sve važne informacije o komentaru recepta. Sadrži atribute: ID komentatora, ID recepta, tekst komentara i datum i vrijeme komentara. Komentar je u \textit{Many-to-One} vezi s korisnikom preko ID-a korisnika koji ga objavi i receptom preko ID-a recepta. 
                ...
                \begin{longtblr}[
					...
					\SetCell{LightBlue}Tekst komentara	& VARCHAR &  tekst komentara 	\\ \hline 
                        ...
                        \SetCell{LightBlue}Datum i vrijeme komentara	& DATETIME &  datum i vrijeme komentara	\\ \hline 
				\end{longtblr}
                ...
                \textbf{Poruka} Ovaj entitet sadržava sve važne informacije o poruci između dva korisnika. Sadrži atribute: ID pošiljatelja, ID primatelja, tekst poruke i datum i vrijeme poruke. Poruka je u vezi \textit{Many-to-One} s primateljem i pošiljateljem preko ID-a korisnika koji palje i prima poruku.
			...
			\begin{figure}[H]
				\includegraphics[scale=0.15]{slike/ER dijagram baze podataka.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		\end{figure}
		\begin{figure}[H]
			\includegraphics[scale=1.3]{slike/dijagram_razreda2.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
