\chapter{Arhitektura i dizajn sustava}
	...
	% \end{itemize}
		...
		\section{Dijagram komponenti}
			...
			Repozitoriji omogućavaju interakciju s H2 in-memory bazom podataka. Ona se koristi za pohranu podataka tijekom trajanja aplikacije. Automatski se stvara prilikom pokretanja backend-a i nestaje nakon gašenja.
